        ...
        <div class="row gx-5">
          <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            <div class="widget-content-wrapper">
              ...
              <div class="widget-bottom mt--40 pt--40">
                <h6 class="title">Get The Latest Land Updates</h6>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt_mobile--40">
            <div class="footer-widget widget-quicklink">
              <h6 class="widget-title">LandReg</h6>
            ...
            <div class="footer-widget">
              ...
              <ul class="footer-recent-post">
                <li class="recent-post">
                  ...
                  <div class="content">
                    <h6 class="title">
                      <a href="product-details.html">#AxL_Community</a>
                    </h6>
                ...
                <li class="recent-post">
                  ...
                  <div class="content">
                    <h6 class="title">
                      <a href="product-details.html">OnkarKulkarni</a>
                    </h6>
                    <p>Highest bid 1/20</p>
                ...
                <li class="recent-post">
                  ...
                  <div class="content">
                    <h6 class="title">
                      <a href="product-details.html">Kartik Bunjkar</a>
                    </h6>
                    <p>Highest bid 1/20</p>
