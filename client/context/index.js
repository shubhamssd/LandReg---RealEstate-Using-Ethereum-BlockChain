...
//INTERNAL  IMPORT
import { LAND_REG_ABI, LAND_REG_ADDRESS } from "./constants";

//FETCH CONTRACT
const FETCH_CONTRACT = (PROVIDER) =>
  new ethers.Contract(LAND_REG_ADDRESS, LAND_REG_ABI, PROVIDER);
